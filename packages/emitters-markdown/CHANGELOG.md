...
- 2d654b6: Initial release of `@kindly-note/emitters-markdown` — a semantic-HTML emitter for the `@kindly-note/lang-markdown` token stream, with **security-first defaults** (spec §1.5 / §13).
