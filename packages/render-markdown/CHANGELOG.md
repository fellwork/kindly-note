...
- 2d654b6: Initial release of `@kindly-note/render-markdown` — the one-call markdown → safe HTML convenience entry point (spec §1.5 / §13).
...
- Updated dependencies [2d654b6]
  ...
  - @kindly-note/emitters-markdown@1.0.0
  - @kindly-note/lang-markdown@0.1.1
