...
// spec §1.5 row `@kindly-note/render-markdown`: one-call markdown → safe HTML.
// Composes lang-markdown + emitters-markdown + a Highlighter; optional lang-*
// peers for code-fence languages.
