...
// spec §1.2 row `@kindly-note/lang-javascript`: default-exports a deep-frozen
// LanguageDefinition<JavaScriptExtensionPoints>; depends on @kindly-note/{core,
// lang-helpers, lang-pack-ecmascript}.
